module.exports.otpTemplate = (code) => {
  ...
  <div style="margin:50px auto;width:70%;padding:20px 0">
    ...
    <p>Thank you for choosing "Brand Name". Use the following OTP to complete your Sign Up procedures. OTP is valid for 5 minutes</p>
...
module.exports.resetPasswordTemplate = (resetLink) => {
  return `<!DOCTYPE html>
<html>
                                            ...
                                            <tr>
                                                <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                                                    <a href=${resetLink} target="_blank"
                                                        style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Reset Password</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
